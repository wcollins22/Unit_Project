...
def homepage(request):
    ...
    if form.is_valid():
        name = form.cleaned_data["name"]
        for person, j in students.items:
            if name == person:
                new_name = name
                bio = j.bio
                genre = j.fav_genre
                ...
                return render(request, "home.html", {"name":name, "person":person, "bio":bio, "new_name":new_name, "genre":genre, "dream":dream, "job":job, "hometown":hometown})
